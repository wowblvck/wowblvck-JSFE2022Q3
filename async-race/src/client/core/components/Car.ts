...
import { CarData, Cars } from "../interfaces/Car";
...
class Car implements Cars {
  ...
  getImage = (color: string) => `
    <svg xmlns="http://www.w3.org/2000/svg" width="10%" viewBox="0 0 1280 640" preserveAspectRatio="xMidYMid meet" xmlns:v="https://vecta.io/nano">
